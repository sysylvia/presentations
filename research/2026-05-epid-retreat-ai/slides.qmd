...
The **Digital Health Economics & Policy Lab** works on one thing: better
health decisions — coordinating **evidence, behavior, and systems**.

AI's first wave was **prediction**. The harder problem — and where the lab
works — is **coordination**: how we *generate, validate, and aggregate*
knowledge when there is no clean answer to check against.

> Epidemiology already lives this — imperfect gold standards, noisy
> surveillance. **AI sharpens the problem; it doesn't escape it.**

So: **when ground truth is scarce or contested, what should AI do?**
...
::: {.column width="55%"}
**Design — randomized experiments.** We randomize **whether the clinician
sees the AI recommendation** *and* the **patient features** they face.
That gives a clean causal estimate of physician–AI complementarity.

**What we measure:** where the team beats either alone — plus
**asymmetric reliance** (over- vs. under-reliance) and **heterogeneous
response**, not model accuracy in isolation.
:::

::: {.column width="45%"}
::: {.callout-note}
### AI's role
The object of measurement — we study the physician–AI *team*, not the
model alone.
:::
:::
